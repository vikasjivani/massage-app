...
public class Main {
	...
	public static void main(String args[]) {
		...
		User stu1 = new User();
		stu1.setEnNo("15soeit11004");
		stu1.setEmail("jerry@gmail.com");
		stu1.setName("jeck");
		stu1.setStatus(1);
		stu1.setType(1);
		
		
		MoNo mn1 = new MoNo("123890",stu1);
		MoNo mn2 = new MoNo("094321",stu1);
		Set<MoNo> monos = new HashSet<>();
		monos.add(mn1);
		monos.add(mn1);
	
		
		Semester sem1 = new Semester("sem4");
		Semester sem2 = new Semester("sem5");
